...
export function getLastAnnouncedVersion(): string {
    return store.get('lastAnnouncedVersion', '')
}

export function setLastAnnouncedVersion(version: string): void {
    store.set('lastAnnouncedVersion', version)
}
